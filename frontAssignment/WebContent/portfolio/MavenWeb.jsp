...
<body>
	...
	<div>
		<p id="projectTitle">MavenWeb</p>
	</div>
	
	<div class="div_slide">
		<ul id="bx">
			<li><img src="../imgs/page02_1.PNG" alt=""></li>
			<li><img src="../imgs/page02_2.PNG" alt=""></li>
			<li><img src="../imgs/page02_3.PNG" alt=""></li>
			<li><img src="../imgs/page02_4.PNG" alt=""></li>
			<li><img src="../imgs/page02_5.PNG" alt=""></li>
			<li><img src="../imgs/page02_6.PNG" alt=""></li>
		</ul>
	</div>
	...
	<div class="div_projectIntro">
		<div class="projectIntro_title">
			...
			<p>maven project로 웹을 구현한 프로젝트</p>
		</div>
		
		<div class="projectIntro_Detail">
			<p><span>&#128198; 작업기간</span><span> : 2019/02/13 ~ 2019/05/16</span></p>
			...
			<p>
				...
				<p>
					...
					<span class="task">&#10004; 로그인, 로그아웃 기능 구현</span><br>
					<span class="task">&#10004; 직원 리스트 CRUD 구현</span><br>
				</p>
			</p>
			<p>
