		...
		<div class="grid12">
			...
			<form class="form-control" method="post">
				<div class="form-group">
					...
					<input type="text" name="empno" id="empno" value='<jsp:getProperty property="empno" name="bean"/>' placeholder="사번을 입력">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="sal" id="sal" value='<jsp:getProperty property="sal" name="bean"/>' placeholder="금액을 입력">
				</div>
				<div class="form-group">
